...
-- Full project script, tasks 1 to 15 in a single file
--
-- This script recreates the database structure and runs every
-- task in order. It is provided as a convenience for anyone who
-- wants to run the whole project in one go. The individual task
-- files in the Queries folder remain the primary reference, each
-- one linked directly from the task table in the README.
-- ============================================================
...
-- Load emp_record_table.csv, proj_table.csv and data_science_team.csv
-- into the three tables above using the Table Data Import Wizard in
-- MySQL Workbench before running the tasks below.
